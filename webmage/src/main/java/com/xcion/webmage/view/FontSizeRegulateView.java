 ...
 * DateTime: 2021/2/27  16:46
 * Intro:
 */
public class FontSizeRegulateView extends View {

    private static final String TAG = "FontSizeRegulateBar";
    ...
    public FontSizeRegulateView(Context context) {
        this(context, null);
    }

    public FontSizeRegulateView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FontSizeRegulateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.FontSizeRegulateView);
            mRadius = typedArray.getInteger(R.styleable.FontSizeRegulateView_radius, 2);
    ...
    private int getCircleInitPositionX() {
        int currentTextSize = 0;//SpUtil.getInstance().getCurrentTextSize();
...
//        fontMetrics.
    ...
    private void expandCircleRadius(boolean isExpand) {
        int defaultRadius = 0;//SpUtil.getInstance().getCurrentRadius();
        if (isExpand) {
